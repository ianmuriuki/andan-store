...
const Home: React.FC = () => {
  ...
  const featuredProducts = [
    ...
    },
    {
      ...
      price: 180,
      image: 'https://images.pexels.com/photos/1586947/pexels-photo-1586947.jpeg?auto=compress&cs=tinysrgb&w=600',
      rating: 4.7,
      reviews: 67,
      category: 'Bakery',
      badge: 'New',
    ...
    },
    {
      ...
      price: 89,
      image: 'https://images.pexels.com/photos/2068303/pexels-photo-2068303.jpeg?auto=compress&cs=tinysrgb&w=600',
      rating: 4.6,
      reviews: 45,
      category: 'Vegetables',
      badge: 'Organic',
  ...
  const categories = [
    ...
    { 
      name: 'Dairy & Eggs', 
      image: 'https://images.pexels.com/photos/4102678/pexels-photo-4102678.jpeg?auto=compress&cs=tinysrgb&w=600',
      count: '50+ items',
    ...
    { 
      name: 'Meat & Seafood', 
      image: 'https://images.pexels.com/photos/2959192/pexels-photo-2959192.jpeg?auto=compress&cs=tinysrgb&w=600',
      count: '80+ items',
  ...
  const features = [
    {
      icon: Truck,
      title: 'Fast Delivery',
      description: 'Get your groceries delivered within 1-2 hours in Nairobi and surrounding areas.',
    ...
    },
    {
      ...
      description: 'Fresh products sourced directly from farms and trusted suppliers with quality assurance.',
    ...
    },
    {
      ...
      description: 'Wide selection of certified organic products for health-conscious customers.',
        ...
        <div className="container-main section-padding">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Shop from the comfort of your home and get fresh, quality groceries delivered within hours. 
                Pay conveniently with M-Pesa and enjoy our premium selection.
              </motion.p>
            ...
            >
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-neutral-800">4.9/5 Rating</p>
                    <p className="text-sm text-neutral-600">From 1000+ reviews</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section ref={productsRef} className="section-padding bg-neutral-50">
        <div className="container-main">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Link to="/products" className="btn-secondary group hidden md:flex">
                View All Products
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200" />
              </Link>
            </motion.div>
                  ...
                  {product.badge && (
                    <motion.div 
                      className={`offer-badge ${
                        ...
                        product.badge === 'Popular' ? 'bg-primary-500' :
                        product.badge === 'New' ? 'bg-accent-blue' :
                        'bg-accent-orange'
                      }`}
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
        ...
        <div className="container-main text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join thousands of satisfied customers who trust Andan for their daily grocery needs. 
              Fresh products, fast delivery, and great prices await you.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link to="/register" className="bg-white text-primary-500 hover:bg-neutral-100 font-medium px-8 py-4 rounded-button transition-all duration-200 min-h-[44px] flex items-center justify-center">
                  <CheckCircle className="w-5 h-5 mr-2" />
                  Create Account
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link to="/products" className="border-2 border-white text-white hover:bg-white hover:text-primary-500 font-medium px-8 py-4 rounded-button transition-all duration-200 min-h-[44px] flex items-center justify-center">
                  <ShoppingCart className="w-5 h-5 mr-2" />
                  Browse Products
                </Link>
              </motion.div>
